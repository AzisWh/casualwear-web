                ...
                @foreach ($transactions as $transaction)
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <img src="{{ asset('storage/' . $transaction->sepatu->image_sepatu) }}" alt="{{ $transaction->sepatu->title }}" class="img-fluid mb-3" style="max-height: 200px; object-fit: cover;">
                                ...
                                @endif
                                {{-- <a href="{{ route('user.checkout.show', $transaction->id) }}" class="btn btn-primary">Lihat Detail</a> --}}
                            </div>
                        </div>
                    </div>
                @endforeach
