    ...
    <div class="col-lg-10 bg-white rounded shadow-sm overflow-hidden">
        <div class="row flex-column flex-lg-row">
            ...
            <div class="col-lg-6 p-0">
                <img src="{{ asset('assets/img/logo-white.jpeg') }}" alt="Login Image" class="img-fluid h-100 w-100 object-fit-cover">
            </div>

            <div class="col-lg-6 p-5">
                <h3 class="mb-4 text-center">Login SuperAdmin</h3>
                <form method="POST" action="{{route('login.super')}}">
                    @csrf
                    <div class="mb-3">
